...
import com.ledu.domain.Course;

import com.ledu.repository.CourseRepository;
...
public class CourseResource {
    ...
    @GetMapping("/courses")
    @Timed
    public ResponseEntity<List<Course>> getAllCourses(Pageable pageable, @RequestParam(required = false) String filter) {
        if ("mainimg-is-null".equals(filter)) {
            log.debug("REST request to get all Courses where mainImg is null");
            return new ResponseEntity<>(StreamSupport
                .stream(courseRepository.findAll().spliterator(), false)
                .filter(course -> course.getMainImg() == null)
